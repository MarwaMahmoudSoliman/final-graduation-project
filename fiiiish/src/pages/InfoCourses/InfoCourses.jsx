  ...
  return (
    <div>
        ...
        <div className='col-lg-6' style={{ height: "30em", width: "42em" }}>
          ...
          <div>
            <h3 style={{ fontSize: "25px", marginTop: "70px", fontWeight: "bold", fontFamily: "fantasy" ,width:"80px",backgroundColor:"red"}}>About Course</h3>
          ...
          <div className='faq-section'>
            <div className='container d-flex flex-column align-items-center' style={{ width: "200px" }}>
              <Accordion defaultActiveKey="" flush style={{ width: "700px" ,marginBottom:"20px" }}>
                <Accordion.Item eventKey='0'>
                  <Accordion.Header>
                    <div className="lecture-title" style={{ marginRight: "28em",marginLeft:"-20px" }}>Rock The Street</div>
